(function($) {
    ...
    function mapConfig() {
        $.gmap3({
            key: 'AIzaSyA-XBs8xkUbYA0ykeWNnxWRP8SMOSQHFW8'
        });
        var map = $('#contact-map');
        if (map.length > 0) {
            map.gmap3({
...
document.addEventListener('DOMContentLoaded', function () {
	...
	const observer = new IntersectionObserver((entries, observer) => {
	  entries.forEach((entry, index) => {
		if (entry.isIntersecting) {
		  ...
		  }, index * 400); // Adjust delay to 200ms for a smoother sequence
  ...
  document.addEventListener('DOMContentLoaded', function () {
	const cards = document.querySelectorAll('.fade-right');
  ...
  document.addEventListener('DOMContentLoaded', function () {
	const cards = document.querySelectorAll('.fade-left');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const leftMenuItems = document.querySelectorAll('#left-menu li a');
    const rightMenuItems = document.querySelectorAll('#right-menu li a');
