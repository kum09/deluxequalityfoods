...
<div class="page-wrap">
        ...
        <div class="rev_slider_wrapper fullscreen-container" id="revolution-slider-1" data-alias="concept121" data-source="gallery" style="background-color:#000000;padding:0px;">
          <div class="rev_slider fullscreenbanner" id="rev_slider_1059_1" style="display:none;" data-version="5.4.1">
            <ul class="ps-banner">
              ...
              <img class="rev-slidebg" src="{{url('public/frontend/assets/images/banner/img-slider-1.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
      ...
      <div class="ps-section pt-80 pb-40">
        <div class="container">
          <div class="ps-countdown">
            <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 "><img src="{{url('public/frontend/assets/images/counter.png')}}" alt="">
                  </div>
            ...
            <div class="owl-slider owl-slider--best-seller" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="true" data-owl-dots="false" data-owl-animate-in="" data-owl-animate-out="" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-nav-left="&lt;i class=&quot;ps-icon--back&quot;&gt;&lt;/i&gt;" data-owl-nav-right="&lt;i class=&quot;ps-icon--next&quot;&gt;&lt;/i&gt;">
              ...
              <div class="ps-product fade-up">
                ...
                <div class="ps-product__content"><a class="ps-product__title" href="#">TUTTI FRUTTI SLICED CAKE</a>
                  <div class="ps-product__category"><a class="ps-product__category" href="#">BURSTING WITH COLORFUL TUTTI FRUTTI PIECES, THIS CAKE IS A
                  VISUAL AND CULINARY DELIGHT.</a>
                  </div>
                  <select class="ps-rating">
                    <option value="1">1</option>
                    <option value="1">2</option>
              ...
              <div class="ps-product fade-up">
                ...
                <div class="ps-product__content"><a class="ps-product__title" href="#">ALMOND CAKE RUSK</a>
                  <div class="ps-product__category"><a class="ps-product__category" href="#">CRISPY AND CRUNCHY, THESE RUSKS ARE ENRICHED WITH THE NUTTY
                  FLAVOR OF ALMONDS.</a>
                  </div>
                  <select class="ps-rating">
                    <option value="1">1</option>
      ...
      <div class="ps-section ps-section--home-testimonial pb-30 bg--parallax" data-background="{{url('public/frontend/assets/images/parallax/img-bg-1.jpg')}}">
        <div class="container">
          <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-animate-in="" data-owl-animate-out="" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-nav-left="&lt;i class=&quot;fa fa-angle-left&quot;&gt;&lt;/i&gt;" data-owl-nav-right="&lt;i class=&quot;fa fa-angle-right&quot;&gt;&lt;/i&gt;">
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="{{url('public/frontend/assets/images/testimonial/1.jpg')}}" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
              ...
              <div class="ps-testimonial__content">
                <p>Love starting my mornings with Deluxe Tea Rusk! These crunchy delights are the perfect companion to a hot cup of tea. Definitely a pantry staple in our household!
                </p>
              </div>
            </div>
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="{{url('public/frontend/assets/images/testimonial/2.jpg')}}" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
              ...
              <div class="ps-testimonial__content">
                <p>Their pav buns are must try so soft and well baked. Deluxe always provide fresh and best quality products.</p>
              </div>
            </div>
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="{{url('public/frontend/assets/images/testimonial/3.jpg')}}" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
              ...
              <div class="ps-testimonial__content">
                <p>Absolutely delicious! The Saunf Biscuit from Deluxe is a delightful blend of flavors. Highly recommended for those who appreciate traditional flavors with a twist
                </p>
              </div>
            </div>
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="{{url('public/frontend/assets/images/testimonial/4.jpg')}}" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
              ...
              <div class="ps-testimonial__content">
                <p>I have been trying their eggless cake rusk for months now and loving it.</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="ps-masonry">
                ...
                <div class="grid-item high wide">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-offer"><img src="{{url('public/frontend/assets/images/offer/banner-1.jpg')}}" alt=""><a class="ps-offer__overlay" href="#"></a></div>
                  </div>
                </div>
                <div class="grid-item">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-offer"><img src="{{url('public/frontend/assets/images/offer/banner-2.jpg')}}" alt=""><a class="ps-offer__overlay" href="#"></a></div>
                  </div>
                </div>
                <div class="grid-item high">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-offer"><img src="{{url('public/frontend/assets/images/offer/banner-3.jpg')}}" alt=""><a class="ps-offer__overlay" href="#"></a></div>
                  </div>
                </div>
                <div class="grid-item wide">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-offer"><img src="{{url('public/frontend/assets/images/offer/banner-4.jpg')}}" alt=""><a class="ps-offer__overlay" href="#"></a></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                  <div class="ps-section__header">
                    <h3 class="ps-section__title ps-section__title--left">CAKE</h3>
                  </div>
                  <div class="ps-section__content">
                    <div class="ps-product--list fade-left">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="#"></a><img src="{{url('public/frontend/assets/images/products/1.png')}}" alt=""></div>
                      <div class="ps-product__content ">
                        <h4 class="ps-product__title"><a href="#">MARBLE POUND CAKE</a></h4>
                        <p>A Classic Treat With A Beautiful Swirl Of Vanilla And
                        Chocolate Flavors.</p>
                    ...
                    <div class="ps-product--list fade-left">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="#"></a><img src="{{url('public/frontend/assets/images/products/2.png')}}" alt=""></div>
                      <div class="ps-product__content">
                        <h4 class="ps-product__title"><a href="#">VANILLA POUND CAKE</a></h4>
                        <p>A Rich, Buttery Pound Cake Infused With The Warm Flavor Of
                        Vanilla.</p>
                        <p class="ps-product__price">
                          <del>₹25.00</del>₹15.00
                        </p><a class="ps-btn ps-btn--xs" href="#">Order now<i class="fa fa-angle-right"></i></a>
                    ...
                    <div class="ps-product--list fade-left">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="#"></a><img src="{{url('public/frontend/assets/images/products/3.png')}}" alt=""></div>
                      <div class="ps-product__content">
                        <h4 class="ps-product__title"><a href="#">TUTTI FRUTTI SLICED CAKE</a></h4>
                        <p>Bursting With Colorful Tutti Frutti Pieces, This Cake Is A
                        Visual And Culinary Delight.</p>
                        <p class="ps-product__price">
                          <del>₹25.00</del>₹15.00
                        </p><a class="ps-btn ps-btn--xs" href="#">Order now<i class="fa fa-angle-right"></i></a>
                      </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                  <div class="ps-section__header">
                    <h3 class="ps-section__title ps-section__title--left">BISCUITS</h3>
                  </div>
                  <div class="ps-section__content">
                    <div class="ps-product--list fade-right">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="#"></a><img src="{{url('public/frontend/assets/images/products/8.png')}}" alt=""></div>
                      <div class="ps-product__content">
                        <h4 class="ps-product__title"><a href="#">MILK PUNJABI BISCUIT</a></h4>
                        <p>Traditional Punjabi Biscuits Are Made With Rich Milk For A
                        Delightful Taste.</p>
                        <p class="ps-product__price">
                          <del>₹25.00</del>₹15.00
                        </p><a class="ps-btn ps-btn--xs" href="#">Order now<i class="fa fa-angle-right"></i></a>
                    ...
                    <div class="ps-product--list fade-right">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="#"></a><img src="{{url('public/frontend/assets/images/products/suji.png')}}" alt=""></div>
                      <div class="ps-product__content">
                        <h4 class="ps-product__title"><a href="#">SOOJI BISCUIT</a></h4>
                        <p>Sweetened With Jaggery, These Biscuits Offer A Unique And
                        Wholesome Flavor.</p>
                        <p class="ps-product__price">
                          <del>₹25.00</del>₹15.00
                        </p><a class="ps-btn ps-btn--xs" href="#">Order now<i class="fa fa-angle-right"></i></a>
                    ...
                    <div class="ps-product--list fade-right">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="#"></a><img src="{{url('public/frontend/assets/images/products/zeera.png')}}" alt=""></div>
                      <div class="ps-product__content">
                        <h4 class="ps-product__title"><a href="#">ZEERA BISCUIT</a></h4>
                        <p>Combining The Sweetness Of Jaggery With The Refreshing
                        Taste Of Fennel Seeds.</p>
                        <p class="ps-product__price">
                          <del>₹25.00</del>₹15.00
                        </p><a class="ps-btn ps-btn--xs" href="#">Order now<i class="fa fa-angle-right"></i></a>
                      </div>
                    ...
                    <div class="row">
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                            <article class="ps-people">
                              <div class="ps-people__thumbnail"><a class="ps-people__overlay" href="#"></a><img src="{{url('public/frontend/assets/images/team/team-1.jpg')}}" alt=""></div>
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                            <article class="ps-people">
                              <div class="ps-people__thumbnail"><a class="ps-people__overlay" href="#"></a><img src="{{url('public/frontend/assets/images/team/team-2.jpg')}}" alt=""></div>
                              <div class="ps-people__content">
                                <h4>Christian Gregory</h4><span class="ps-people__position">CEO - Founder</span>
                                <p>Jelly topping halvah caramels sweet cake gummi bears toffee.</p>
                                    <ul class="ps-people__social">
      ...
      <section class="ps-section ps-section--news ps-section--pattern pt-100 pb-100">
        <div class="container">
          ...
          <div class="ps-section__content">
            <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                    <div class="ps-new ps-new--large"><img src="{{url('public/frontend/assets/images/new/new-large.jpg')}}" alt="">
                      <div class="ps-new__container">
                        <header class="ps-new__header">
                          <p>by<a href="#"> Athony</a> / February 12, 2017</p><a class="ps-new__title" href="#">Sweet Bakery by <br> Joni William</a>
                        </header>
                        <div class="ps-new__content">
                          <p data-number-line="2">Fond his say old meet cold find come <br> whom. The sir park sake bred.</p><a class="ps-btn ps-btn--sm" href="#">Read more</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                    <div class="ps-new"><img src="{{url('public/frontend/assets/images/new/new-small-1.jpg')}}" alt="">
                      <div class="ps-new__container">
                        <header class="ps-new__header">
                          <p>by<a href="#"> Athony</a> / February 12, 2017</p><a class="ps-new__title" href="#">Where I Learning Cook Cupcakes ?</a>
                        </header>
                        <div class="ps-new__content">
                          <p data-number-line="2">No comfort do written conduct at prevent manners on. Celebrated contrasted discretion him sympath</p><a class="ps-btn ps-btn--sm" href="#">Read more</a>
                        </div>
                      </div>
                    </div>
                    <div class="ps-new"><img src="{{url('public/frontend/assets/images/new/new-small-2.jpg')}}" alt="">
                      <div class="ps-new__container">
                        <header class="ps-new__header">
                          <p>by<a href="#"> Athony</a> / February 12, 2017</p><a class="ps-new__title" href="#">Where I Learning Cook Cupcakes ?</a>
                        </header>
      ...
      <section class="ps-section ps-section--map">
        ...
        <div class="ps-delivery">
          ...
          <div class="ps-delivery__content">
            <form class="ps-delivery__form" action="https://nouthemes.net/html/bakery/#" method="post">
